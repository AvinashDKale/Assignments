...
public class Application extends Controller {
    ...
    /**
     * Simple ping method, demonstrating the use of Futures and asynchronous
     * processing
     *
     * @param msg
     * @return
    ...
    public CompletionStage<Result> ping(String msg) {
        return FutureConverters.toJava(ask(pingActor, new ActorModel.Ping(msg), 1000))
   ...
   response.toString()));
    ...
    /**
     * Accept a form post and save the comment Shows the usage of dynamic forms to
     * retrieve data from html form posts
     *
     * @return
     */
    ...
    /**
     * Search a book by title. Demonstrating the various route configuration
     * semantics
     *
     * @param title
     * @return
    ...
    public CompletionStage<Result> recomendGifts(final String uid, final String age, final String relation) {
        return CompletableFuture.supplyAsync(this::getGifts).thenApply((List<GiftVO> gift) -> ok("Got " + gift));
    }
